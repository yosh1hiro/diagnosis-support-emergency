...
class DiseasesControllerTest < ActionController::TestCase
  ...
  test "should create disease" do
    assert_difference('Disease.count') do
      post :create, disease: { cheif_complaint: @disease.cheif_complaint, name: @disease.name, pre_probability: @disease.pre_probability }
    end
  ...
  test "should update disease" do
    patch :update, id: @disease, disease: { cheif_complaint: @disease.cheif_complaint, name: @disease.name, pre_probability: @disease.pre_probability }
    assert_redirected_to disease_path(assigns(:disease))
  end
